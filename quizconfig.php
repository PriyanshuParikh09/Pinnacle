      ...
      <div class="row" style="margin-top: 100px">
        <div class="col-lg-9 col-md-9 ml-auto mr-auto" >
          <div class="card card-login" >
            ...
            <?php              
              $quiznumber = $_POST["quiznumber"]?? null;
              $typeamarks = $_POST["typeamarks"]?? null;
              $typea = $_POST["typea"]?? null;
              $typebmarks = $_POST["typebmarks"]?? null;
              $typeb = $_POST["typeb"]?? null;
              $typecmarks = $_POST["typecmarks"]?? null;
              $typec = $_POST["typec"]?? null;
              $typedmarks = $_POST["typedmarks"]?? null;
              $typed = $_POST["typed"]?? null;
              $typeemarks = $_POST["typeemarks"]?? null;
              $typee = $_POST["typee"]?? null;
              $typefmarks = $_POST["typefmarks"]?? null;
              $typef = $_POST["typef"]?? null;
